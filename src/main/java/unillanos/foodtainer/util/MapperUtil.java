...
public class MapperUtil {
    ...
    public static PictureDTO entityToDtoPicture(Picture picture) {
    ...
    public static RestaurantDTO entityToDtoRestaurant(Restaurant restaurant) {
        RestaurantDTO restaurantDTO = new RestaurantDTO();
        restaurantDTO.setId(restaurant.getIdRestaurant());
        restaurantDTO.setName(restaurant.getNameRestaurant());
        restaurantDTO.setEmail(restaurant.getEmailRestaurant().getEmailUser());
    ...
    public static ContactDTO entityToDtoContact(Contact contact) {
        ...
        contactDTO.setUrlFacebook(contact.getUrlFacebook());
        contactDTO.setUrlInstagram(contactDTO.getUrlInstagram());
        contactDTO.setUrlWebpage(contact.getUrlWebpage());
        return contactDTO;
    }

    public static HeadquarterDTO entityToDtoHeadquarter(Headquarter headquarter) {
        ...
        headquarterDTO.setRestaurant(entityToDtoRestaurant(headquarter.getRestaurant()));
